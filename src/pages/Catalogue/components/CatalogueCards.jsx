...
import {
  ActionIcon,
  AspectRatio,
  Group, Image, Popover, Stack, Switch, Text, Title,
} from '@mantine/core';
import {
...
function ToggleInStockStatus({ id }) {
...
function CatalogueCards({
  data: {
    name, imageURL, perPrice, catalogueMutate, _id,
  },
}) {
  const navigate = useNavigate(); return (
    ...
    >
      ...
      >
        <Title order={6} tt="capitalize">{name}</Title>
